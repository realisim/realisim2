...
mIsVerbose( false )
{
    ...
    const Vector3 p(0.0);
    const Vector3 v(0.0);
    const Vector3 l(0.0, 0.0, -1.0);
    const Vector3 u(0.0, 1.0, 0.0);
    setListenerGain( 1.0 );
...
int AudioInterface::addSource()
{
    ...
    setSourcePosition( id, Vector3(0.0) );
    setSourceVelocity( id, Vector3(0.0) );
...
//------------------------------------------------------------------------------
Vector3 AudioInterface::getListenerPosition() const
{
    float x, y, z;
...
//------------------------------------------------------------------------------
Vector3 AudioInterface::getListenerVelocity() const
{
    float x, y, z;
...
//------------------------------------------------------------------------------
Vector3 AudioInterface::getListenerLookDirection() const
{
    float o[6];
...
//------------------------------------------------------------------------------
Vector3 AudioInterface::getListenerUp() const
{
    float o[6];
    alGetListenerfv( AL_ORIENTATION, o );
    return Vector3( o[3], o[4], o[5] );
}
...
//------------------------------------------------------------------------------
Math::Vector3 AudioInterface::getSourceDirection( int iId ) const
{
    float x, y, z;
...
//------------------------------------------------------------------------------
Vector3 AudioInterface::getSourcePosition( int iId ) const
{
    float x, y, z;
...
//------------------------------------------------------------------------------
Vector3 AudioInterface::getSourceVelocity( int iId ) const
{
    float x, y, z;
