...
TEST(Vector3, operator)
{
    ...
    //bool operator <= (const Vector2 &vect) const;
    {
        Vector3 ref(4.0, 5.0, 6.0);

        Vector3 v1(4.1, 5.0, 6.0);
        Vector3 v2(4.0, 5.1, 6.0);
        Vector3 v3(4.0, 5.0, 6.1);
        Vector3 v4(4.1, 5.1, 6.1);

        Vector3 v5(3.9, 5.0, 6.0);
        Vector3 v6(4.0, 4.9, 6.0);
        Vector3 v7(4.0, 5.0, 5.9);
        Vector3 v8(3.9, 4.9, 5.9);
