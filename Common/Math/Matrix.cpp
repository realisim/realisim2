...
{
    double x,y,z,w;
    x = m[0][0]*iV.x() + m[1][0]*iV.y() + m[2][0]*iV.z() + m[3][0]*iV.w();
    y = m[0][1]*iV.x() + m[1][1]*iV.y() + m[2][1]*iV.z() + m[3][1]*iV.w();;
    z = m[0][2]*iV.x() + m[1][2]*iV.y() + m[2][2]*iV.z() + m[3][2]*iV.w();;
    w = m[0][3]*iV.x() + m[1][3]*iV.y() + m[2][3]*iV.z() + m[3][3]*iV.w();;
