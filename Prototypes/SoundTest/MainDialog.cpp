...
void MainDialog::updateUi()
{
    ...
    switch (ss)
    {
    case Realisim::Audio::AudioInterface::ssInitial: playStop = "Play"; break;
    case Realisim::Audio::AudioInterface::ssPlaying: playStop = "Stop"; break;
    case Realisim::Audio::AudioInterface::ssPaused: break;
    case Realisim::Audio::AudioInterface::ssStopped: playStop = "Play"; break;
    default: break;
    }
...
void MainDialog::xPosChanged(int iV)
{
    ...
    mAudio.setSourcePosition(mWave0SourceId, Math::Vector3(xPos, yPos, 0.0) );
